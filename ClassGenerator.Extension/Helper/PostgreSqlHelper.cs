...
namespace ClassGenerator.Extension.Helper
{
    ...
    {
        public const string TableSql = "SELECT schemaname  as SchemaName,tablename as Name from pg_catalog.pg_tables";
        public const string ViewSql = "SELECT schemaname as SchemaName,viewname as Name from pg_catalog.pg_views";
